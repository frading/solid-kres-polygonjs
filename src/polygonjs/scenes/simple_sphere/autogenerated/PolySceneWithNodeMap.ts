...
export interface PolySceneProps_simple_sphere {
  ...
  "ground-planeHelper1--size"?: ParamValueSerializedTypeMap["float"];
  "ground-planeHelper1--colorCenterLine"?: ParamValueSerializedTypeMap["color"];
  "ground-planeHelper1--colorCenterLine-colorCenterLiner"?: ParamValueSerializedTypeMap["float"];
  "ground-planeHelper1--colorCenterLine-colorCenterLineg"?: ParamValueSerializedTypeMap["float"];
  "ground-planeHelper1--colorCenterLine-colorCenterLineb"?: ParamValueSerializedTypeMap["float"];
  "ground-planeHelper1--colorCenterLiner"?: ParamValueSerializedTypeMap["float"];
  "ground-planeHelper1--colorCenterLineg"?: ParamValueSerializedTypeMap["float"];
  "ground-planeHelper1--colorCenterLineb"?: ParamValueSerializedTypeMap["float"];
  "ground-planeHelper1--colorGrid"?: ParamValueSerializedTypeMap["color"];
  "ground-planeHelper1--colorGrid-colorGridr"?: ParamValueSerializedTypeMap["float"];
  "ground-planeHelper1--colorGrid-colorGridg"?: ParamValueSerializedTypeMap["float"];
  "ground-planeHelper1--colorGrid-colorGridb"?: ParamValueSerializedTypeMap["float"];
  "ground-planeHelper1--colorGridr"?: ParamValueSerializedTypeMap["float"];
  "ground-planeHelper1--colorGridg"?: ParamValueSerializedTypeMap["float"];
  "ground-planeHelper1--colorGridb"?: ParamValueSerializedTypeMap["float"];
